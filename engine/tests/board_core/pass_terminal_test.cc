...
TEST_CASE("pass moves are rejected unless exactly one side can move", "[board_core][pass_terminal]") {
...
TEST_CASE("terminal positions require neither side to have a legal move", "[board_core][pass_terminal]") {
